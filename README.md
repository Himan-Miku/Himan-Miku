...
[![My Skills](https://skillicons.dev/icons?i=figma,bash,java,js,ts,rust,tailwind,react,nextjs,docker,flutter,firebase,mongodb,postgres,prisma,git,nginx,aws,solidity&perline=8)](https://skillicons.dev)
