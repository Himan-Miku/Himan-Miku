...
[![My Skills](https://skillicons.dev/icons?i=figma,bash,java,js,ts,rust,tailwind,react,nextjs,docker,firebase,mongodb,postgres,prisma,git,aws,solidity&perline=8)](https://skillicons.dev)
